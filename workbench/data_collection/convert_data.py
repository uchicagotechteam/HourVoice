...
def get_subset(hourvoice_id, establishment):
    global num_with_freq, biz, osha, only_food_inspection
    subset = {'hourvoice_id': hourvoice_id, 'business_name': '', 'address': '', 'frequency': '', 'owner': '', 'business_license_number': '', 'zip_code': '', 'city': ''}
    ...
    if 'business_license' in establishment:
        ...
        subset['business_name'] = establishment['business_license']['doing_business_as_name']
        ...
        osha += 1
        subset['business_name'] = establishment['OSHA']['Employer']
